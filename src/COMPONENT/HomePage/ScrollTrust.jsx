...
export default function InteriorExpertiseSection() {
  const items = [
    "Personalized Interior Concepts",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        ...
        <div className="mx-auto mb-16 max-w-5xl text-center">
          ...
          <p className="tex-black mt-10">
            Infinity Space is a trusted interior design company in Bhubaneswar,
            ...
            wardrobe designs, TV units, false ceiling concepts, and turnkey
            execution, every space is designed with attention to detail and
            practical usability.
          </p>
          <p className="tex-black mt-10">
